...
func TestIdentityKeysAndBalance(t *testing.T) {
	...
	testFastPolicy(t, a, admin)
	testProfitControl(t, a, admin)
	testMessagesDispatch(t, a, admin)
	testMessagesCounting(t, a, admin)
	testLocalTokenCounting(t, a, admin)
	...
	testAccountState(t, a, admin, otherToken)
	testPlanLifecycle(t, a, admin, otherToken)
