...
func (a *App) resolveClientGroup(r *http.Request, g *gatewayIdentity) error {
	...
	if policy.Protocol == "chat_completions" || policy.Protocol == "responses" || policy.Protocol == "embeddings" || policy.Protocol == "alpha_search" || grokSearchProtocol(policy.Protocol) || voiceProtocol(policy.Protocol) || policy.Protocol == "custom-voices" {
