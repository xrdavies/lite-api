...
type usageReceipt struct {
	...
	At                                                                                 time.Time
	IP, UserAgent, Inbound, UpstreamRequestID                                          string
	BillingMode                                                                        string
}
